        ...
        <section className="intro-section">
          <div className="intro-content">
            ...
            <p className="description">
              ...
              My passion lies in backend development, building secure and efficient data systems, and writing well-tested code that scales reliably. I also have a specialization in <strong>system architecture</strong> and <strong>distributed systems</strong>.
            </p>
            <p className="description">
